...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Timeout toast mimicking backend welcome
      setTimeout(() => {
    ...
    <div className="dot-pattern min-h-screen w-full flex items-center justify-center p-6 bg-[#f9f9ff] relative overflow-x-hidden">
      ...
      <main className="w-full max-w-[480px] z-10 py-10">
        ...
        <div className="text-center mb-stack-lg flex flex-col items-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary mb-stack-md clay-button text-white">
        ...
        <div className="clay-card p-container-padding border border-white/40 bg-white">
          <header className="mb-stack-lg text-left">
            ...
            <p className="font-body-md text-on-surface-variant leading-relaxed">Continue your learning journey with AI.</p>
          </header>
          ...
          <form className="space-y-stack-md text-left" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center gap-2 px-1 py-1">
              <input 
                className="w-5 h-5 rounded border-outline-variant text-primary focus:ring-primary/20 transition-all cursor-pointer bg-[#f1f3ff]" 
                id="remember" 
                type="checkbox"
              />
        ...
        <p className="text-center mt-stack-lg font-body-md text-on-surface-variant">
          ...
          <Link className="text-primary font-bold hover:underline transition-all" to="/register">Create free account</Link>
        </p>
